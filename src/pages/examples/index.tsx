...
export async function exampleSitemap (ctx:Context) {
...
export async function examplesRouter <State extends {}> (r:Router<State>) {
	r
		.get('', async (ctx) => {
			return ctx.html(<Layout title="TriFrost Examples" description="A running log of what’s new in TriFrost" section="examples">
				<Page width={"130rem"}>
