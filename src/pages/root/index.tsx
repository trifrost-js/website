    ...
    return ctx.html(<Layout section="home">
        <Page style={{position: 'relative'}}>
            ...
            <p className={css.use('text_header_thin', 'sm_h_auto', {
				...
				A blazing-fast, runtime-agnostic server framework built for the modern JavaScript ecosystem
				 — from low-latency edge environments to traditional backend infrastructure
            </p>
